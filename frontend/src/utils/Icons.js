...
export const calci = <i class="fa-solid fa-calculator"></i>
export const graphIcon =<i class="fa-solid fa-chart-simple"></i>
export const categoryIcon =<i class="fa-solid fa-list"></i>
export const monthIcon =<i class="fa-solid fa-calendar-days"></i>